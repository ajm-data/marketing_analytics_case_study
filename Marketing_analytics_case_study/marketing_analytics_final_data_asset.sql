...
/*---------------------------------------------------
#####################################################
For each customer we need to identify their top 2 favorite
categories based off their past rental history. 
#####################################################
----------------------------------------------------*/
...
Used for future insights to see percentage of top 2 
category viewing history (per customer) compared to
overall viewing history 
---------------------------------------------------- */
...
/* ---------------------------------------------------
Rank customer's top categories by rental_count.

Then identify the top 2 categories for each customer
  * `top_categories`
---------------------------------------------------- */
...
Used for insight to compare customer's top category count
to the average customer's category
---------------------------------------------------- */
...
/* ---------------------------------------------------
Calculate the percentile metric for each customer's
...
/* ---------------------------------------------------
Generate our first top category insights table using all 
...
/* --------------------------------------------------------------
 Generate a summarised film count table with the category
included, we will use this table to rank the films by popularity
  * `film_counts`

Most popular films will then be used as recommendations for customer's
...
/* ---------------------------------------------------
We cannot recommend a film that the customer has already
watched. Table will be used for anti join
 
Create a previously watched films for the top 2
...
/* -------------------------------------------------------------------------
Perform an anti join from the relevant category films on the
...
/* ---------------------------------------------------
Identify the top actor and their respective rental
...
/* ---------------------------------------------------
Generate total actor rental counts to use for film
...
/* -------------------------------------------------
Create an updated film exclusions table which
...
/* -------------------------------------------------
Perform anti join and use a window function to identify 
the 3 valid film recommendations for our customers
...
/*------------------------------------------------------------------
Create final data asset for marketing team. Explicitly write out 
insights using CONCAT that will be used in e-mail template, while
populating each insight with relevant data metrics that marketing 
has asked for.
--------------------------------------------------------------------*/
